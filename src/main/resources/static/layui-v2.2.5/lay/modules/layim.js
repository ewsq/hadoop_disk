...
;layui.define(["layer", "laytpl", "upload"], function (i) {
    var a = "3.7.6", e = layui.$, t = layui.layer, n = layui.laytpl, l = layui.device(), s = "layui-show",
        o = "layim-this", d = 20, r = {}, c = function () {
            this.v = a, e("body").on("click", "*[layim-event]", function (i) {
                var a = e(this), t = a.attr("layim-event");
    ...
    var u = function (i) {
            var a = {friend: "该分组下暂无好友", group: "暂无群组", history: "暂无历史会话"};
    ...
    layui.data.date = function (i) {
        ...
        return i = (i || "").replace(/&(?!#?[a-zA-Z0-9]+;)/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/'/g, "&#39;").replace(/"/g, "&quot;").replace(/@(\S+)(\s+?|$)/g, '@<a href="javascript:;">$1</a>$2').replace(/face\[([^\s\[\]]+?)\]/g, function (i) {
            ...
            var a = (i.match(/a\(([\s\S]+?)\)\[/) || [])[1], e = (i.match(/\)\[([\s\S]*?)\]/) || [])[1];
    ...
    var x, b, w, k, C, S = function (i, a, n) {
        return i = i || {}, e.ajax({
            ...
            cache: !1,
            success: function (i) {
                0 == i.code ? a && a(i.data || {}) : t.msg(i.msg || (n || "Error") + ": LAYIM_NOT_GET_DATA", {time: 5e3})
            },
            error: function (i, a) {
                window.console && console.log && console.error("LAYIM_DATE_ERROR：" + a)
            }
        })
    }, j = {message: {}, chat: []}, H = function (i) {
        var a = i.init || {};
        return mine = a.mine || {}, local = layui.data("layim")[mine.id] || {}, obj = {
            ...
            var t = a.mine || {}, l = layui.data("layim")[t.id] || {}, s = {
                base: i,
                local: l,
                mine: t,
                friend: a.friend || [],
        ...
        return t.open({
            ...
            cancel: function (i) {
                ...
                return a.close = !0, layui.data("layim", {key: j.mine.id, value: a}), !1
            }
        })
    }, A = function () {
        ...
        return b && t.close(b.attr("times")), x && x.hide(), j.mine = j.mine || {}, t.open({
            ...
            success: function (i, a) {
                b = i, j.base.right && i.css("margin-left", "-" + j.base.right), i.on("click", function () {
                    ...
                    delete i.close, layui.data("layim", {key: j.mine.id, value: i})
                })
            }
        })
    }, z = function (i) {
        i = i || {};
        var a = e("#layui-layim-chat"), l = {data: i, base: j.base, local: j.local};
        if (!i.id) return t.msg("非法用户");
        if (a[0]) {
            var s = w.find(".layim-chat-list"), o = s.find(".layim-chatlist-" + i.type + i.id),
                d = w.find(".layui-layer-max").hasClass("layui-layer-maxmin"), c = a.children(".layim-chat-box");
            return "none" === w.css("display") && w.show(), k && t.close(k.attr("times")), 1 !== s.find("li").length || o[0] || (d || w.css("width", 800), s.css({height: w.height()}).show(), c.css("margin-left", "200px")), o[0] || (s.append(n(v).render(l)), c.append(n(f).render(l)), I(i), E()), O(s.find(".layim-chatlist-" + i.type + i.id)), o[0] || U(), $(i), Q(), C
        }
        l.first = !0;
        var u = C = t.open({
            type: 1,
            ...
            full: function (i) {
                t.style(u, {width: "100%", height: "100%"}, !0), E()
            },
            resizing: E,
            restore: E,
            min: function () {
        ...
        var i = w.find(".layim-chat-list"), a = w.find(".layim-chat-main"), e = w.height();
        i.css({height: e}), a.css({height: e - 20 - 80 - 158})
    }, N = function (i) {
        var a = i || _().data, n = layui.layim.cache().base;
        w && !i && w.hide(), t.close(N.index), N.index = t.open({
            ...
            success: function (a, l) {
                i || (k = a), n.minRight && t.style(l, {left: e(window).width() - a.outerWidth() - parseFloat(n.minRight)}), a.find(".layui-layer-content span").on("click", function () {
        ...
        return i = i || {}, t.close(M.index), M.index = t.open({
            type: 1,
            area: "430px",
            title: {friend: "添加好友", group: "加入群组"}[i.type] || "",
            shade: !1,
            resize: !1,
            btn: a ? ["确认", "取消"] : ["发送申请", "关闭"],
            content: n(p).render({
        ...
        var n = i.index() === -1 ? 0 : i.index(), l = ".layim-chat", d = w.find(l).eq(n),
        ...
        var i = _(), a = j.message[i.data.type + i.data.id];
        a && delete j.message[i.data.type + i.data.id]
    }, _ = function () {
        if (w) {
            var i = e(".layim-chat-list ." + o).index(), a = w.find(".layim-chat").eq(i),
                t = JSON.parse(decodeURIComponent(a.find(".layim-chat-tool").data("json")));
            return {elem: a, data: t, textarea: a.find("textarea")}
        }
    }, R = function (i) {
        var a = layui.data("layim")[j.mine.id] || {}, e = a.skin;
        i.css({
        ...
        var a = layui.data("layim")[j.mine.id] || {}, e = {}, t = a.history || {}, l = t[i.type + i.id];
        if (x) {
            ...
            if (i.historyTime = (new Date).getTime(), t[i.type + i.id] = i, a.history = t, layui.data("layim", {
                ...
                e[i.type + i.id] = i;
                var o = n(u({type: "history", item: "d.data"})).render({data: e});
        ...
        i = i || {};
        var a = e(".layim-chatlist-" + i.type + i.id), t = {}, l = a.index();
        if (i.timestamp = i.timestamp || (new Date).getTime(), i.fromid == j.mine.id && (i.mine = !0), i.system || B(i), G = JSON.parse(JSON.stringify(i)), j.base.voice && F(), !w && i.content || l === -1) {
            ...
            }), N({name: "收到新消息", avatar: t.avatar || i.avatar, anim: 6})
        }
        if (w) {
            var d = _();
            ...
            var r = w.find(".layim-chat").eq(l), c = r.find(".layim-chat-main ul");
        ...
        layui.data("layim", {key: j.mine.id, value: a})
    }, U = function () {
        var i = layui.data("layim")[j.mine.id] || {}, a = _(), e = i.chatlog || {},
        ...
        if (j[i.type]) if ("friend" === i.type) layui.each(j.friend, function (n, l) {
            ...
            }), a ? t.msg("好友 [" + (i.username || "") + "] 已经存在列表中", {anim: 6}) : (j.friend[n].list = j.friend[n].list || [], e[j.friend[n].list.length] = i, i.groupIndex = n, j.friend[n].list.push(i), !0)
        }); else if ("group" === i.type) {
            if (layui.each(j.group, function (e, t) {
                if (t.id == i.id) return a = !0
            }), a) return t.msg("您已是 [" + (i.groupname || "") + "] 的群成员", {anim: 6});
        ...
        j[i.type] && ("friend" === i.type ? layui.each(j.friend, function (e, t) {
            layui.each(t.list, function (t, n) {
                if (i.id == n.id) {
                    ...
                    return l.find(".layui-layim-list>li").eq(t).remove(), j.friend[e].list.splice(t, 1), l.find(".layim-count").html(j.friend[e].list.length), 0 === j.friend[e].list.length && l.find(".layui-layim-list").html('<li class="layim-null">该分组下已无好友了</li>'), !0
                }
            })
        }) : "group" === i.type && layui.each(j.group, function (e, t) {
            if (i.id == t.id) return a.find(">li").eq(e).remove(), j.group.splice(e, 1), 0 === j.group.length && a.html('<li class="layim-null">暂无群组</li>'), !0
        }))
    }, Z = function () {
        var i = _(), a = i.elem.find(".layim-chat-main"), e = a.find("ul"), t = e.find("li").length;
        if (t >= d) {
        ...
        var i = _(), a = i.textarea;
        a.focus(), a.off("keydown").on("keydown", function (i) {
            var e = layui.data("layim")[j.mine.id] || {}, t = i.keyCode;
        ...
        status: function (i, a) {
            ...
            var a = i.attr("lay-type"), e = "true" === a ? "false" : "true", t = layui.data("layim")[j.mine.id] || {};
            ...
            var a = x.find(".layui-layim-search"), e = x.find("#layui-layim-search"), t = a.find("input"),
                n = function (i) {
                    var a = t.val().replace(/\s/);
                    if ("" === a) ti.tab(0 | ti.tab.index); else {
                        for (var n = [], l = j.friend || [], s = j.group || [], o = "", d = 0; d < l.length; d++) for (var r = 0; r < (l[d].list || []).length; r++) l[d].list[r].username.indexOf(a) !== -1 && (l[d].list[r].type = "friend", l[d].list[r].index = d, l[d].list[r].list = r, n.push(l[d].list[r]));
                        for (var c = 0; c < s.length; c++) s[c].groupname.indexOf(a) !== -1 && (s[c].type = "group", s[c].index = c, s[c].list = c, n.push(s[c]));
                        if (n.length > 0) for (var u = 0; u < n.length; u++) o += '<li layim-event="chat" data-type="' + n[u].type + '" data-index="' + n[u].index + '" data-list="' + n[u].list + '"><img src="' + n[u].avatar + '"><span>' + (n[u].username || n[u].groupname || "佚名") + "</span><p>" + (n[u].remark || n[u].sign || "") + "</p></li>"; else o = '<li class="layim-null">无搜索结果</li>';
                        e.html(o), ti.tab(3)
                    }
                };
            ...
            e.skin = a, a || delete e.skin, layui.data("layim", {key: j.mine.id, value: e});
            try {
                x.css({"background-image": a ? "url(" + a + ")" : "none"}), w.css({"background-image": a ? "url(" + a + ")" : "none"})
            } catch (t) {
            }
            ...
            var a = layui.data("layim")[j.mine.id] || {}, e = i.data("type"), t = i.data("index"),
                n = i.attr("data-list") || i.index(), l = {};
            ...
            var n = i.find(".layui-icon"), l = function () {
            ...
            i.data("down") ? l() : (n.html("&#xe619;"), i.data("down", !0), ti.groupMembers.index = t.tips('<ul class="layim-members-list"></ul>', i, {
                ...
                success: function (a) {
                    var t = j.base.members || {}, n = _(), s = a.find(".layim-members-list"), o = "", d = {},
                        c = w.find(".layui-layer-max").hasClass("layui-layer-maxmin"),
                        u = "none" === w.find(".layim-chat-list").css("display");
                    c && s.css({width: e(window).width() - 22 - (u || 200)}), t.data = e.extend(t.data, {id: n.data.id}), S(t, function (a) {
                        layui.each(a.list, function (i, a) {
                            o += '<li data-uid="' + a.id + '"><a href="javascript:;"><img src="' + a.avatar + '"><cite>' + a.username + "</cite></a></li>", d[a.id] = a
                        }), s.html(o), i.find(".layim-chat-members").html(a.members || (a.list || []).length + "人"), s.find("li").on("click", function () {
                            var i = e(this).data("uid"), a = d[i];
                            z({name: a.username, type: "friend", avatar: a.avatar, id: a.id}), l()
            ...
            var t = ti.setSend.box = i.siblings(".layim-menu-box"), n = i.attr("lay-type");
            if ("show" === n) ii(a), t.show().addClass(ei), e(document).off("click", ti.setSendHide).on("click", ti.setSendHide); else {
                ...
                l.sendHotKey = n, layui.data("layim", {key: j.mine.id, value: l}), ti.setSendHide(a, i.parent())
            }
            ...
            n = '<ul class="layui-clear layim-face-list">' + n + "</ul>", ti.face.index = t.tips(n, i, {
                ...
                e(window).off("resize", ti.faceHide).on("resize", ti.faceHide), ii(a)
        }, faceHide: function () {
            ...
            layui.upload.render({
                ...
                accept: a,
                    ...
                    0 == i.code ? (i.data = i.data || {}, "images" === a ? ai(n.textarea[0], "img[" + (i.data.src || "") + "]") : "file" === a && ai(n.textarea[0], "file(" + (i.data.src || "") + ")[" + (i.data.name || "下载文件") + "]"), D()) : t.msg(i.msg || "上传失败")
                }
            })
        },filestore: function (i) {
            t.open({
                type: 2,
                title: "文件库",
                shade: !1,
        ...
        ,media: function (i) {
            ...
            var a = i.data("audio"), e = a || document.createElement("audio"), n = function () {
                e.pause(), i.removeAttr("status"), i.find("i").html("&#xe652;")
            };
            return i.data("error") ? t.msg("播放音频源异常") : e.play ? void (i.attr("status") ? n() : (a || (e.src = i.data("src")), e.play(), i.attr("status", "pause"), i.data("audio", e), i.find("i").html("&#xe651;"), e.onended = function () {
                n()
            }, e.onerror = function () {
                t.msg("播放音频源异常"), i.data("error", !0), n()
            })) : t.msg("您的浏览器不支持audio")
        }, playVideo: function (i) {
            var a = i.data("src"), e = document.createElement("video");
            ...
            var n = layui.data("layim")[j.mine.id] || {}, l = i.parent(), s = i.data("type"),
                o = x.find(".layim-list-history"), d = '<li class="layim-null">暂无历史会话</li>';
            if ("one" === s) {
                var r = n.history;
            ...
            } else "all" === s && (delete n.history, layui.data("layim", {key: j.mine.id, value: n}), o.html(d));
            t.closeAll("tips")
        }
    };
    i("layim", new c)
